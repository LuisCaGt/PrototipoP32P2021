...
try {
            if ((new File("src\\ayuda\\MantenimientoDVD.chm")).exists()) {
                Process p = Runtime
                        .getRuntime()
                        .exec("rundll32 url.dll,FileProtocolHandler src\\ayuda\\MantenimientoDVD.chm");
                p.waitFor();
            } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        dvdEliminar.setId_Dvd(Integer.parseInt(txtId.getText()));
